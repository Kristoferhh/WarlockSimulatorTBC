  ...
  fetch('./WarlockSim.wasm')
    ...
    .then(module => {
      try {
        ...
        auras.powerOfTheGuardianWarlock = playerData.auras.powerOfTheGuardianWarlock || false;
        auras.powerOfTheGuardianMage = playerData.auras.powerOfTheGuardianMage || false;
        auras.eyeOfTheNight = playerData.auras.eyeOfTheNight || false;
        auras.chainOfTheTwilightOwl = playerData.auras.chainOfTheTwilightOwl || false;
        auras.jadePendantOfBlasting = playerData.auras.jadePendantOfBlasting || false;
        ...
        auras.judgementOfTheCrusader = playerData.auras.judgementOfTheCrusader || false;
        ...
        auras.curseOfRecklessness = playerData.auras.curseOfRecklessness || false;
        ...
        auras.improvedHuntersMark = playerData.auras.improvedHuntersMark || false;
        ...
        auras.petStrengthOfEarthTotem = playerData.auras.strengthOfEarthTotem || false;
        ...
        talents.improvedCorruption = parseInt(playerData.talents.improvedCorruption) || 0;
        talents.improvedLifeTap = parseInt(playerData.talents.improvedLifeTap) || 0;
        talents.improvedCurseOfAgony = parseInt(playerData.talents.improvedCurseOfAgony) || 0;
        talents.amplifyCurse = parseInt(playerData.talents.amplifyCurse) || 0;
        talents.nightfall = parseInt(playerData.talents.nightfall) || 0;
        talents.empoweredCorruption = parseInt(playerData.talents.empoweredCorruption) || 0;
        ...
        talents.unstableAffliction = parseInt(playerData.talents.unstableAffliction) || 0;
        talents.improvedImp = parseInt(playerData.talents.improvedImp) || 0;
        talents.demonicEmbrace = parseInt(playerData.talents.demonicEmbrace) || 0;
        ...
        talents.improvedSuccubus = parseInt(playerData.talents.improvedSuccubus) || 0;
        ...
        talents.demonicSacrifice = parseInt(playerData.talents.demonicSacrifice) || 0;
        talents.manaFeed = parseInt(playerData.talents.manaFeed) || 0;
        talents.masterDemonologist = parseInt(playerData.talents.masterDemonologist) || 0;
        talents.soulLink = parseInt(playerData.talents.soulLink) || 0;
        talents.demonicKnowledge = parseInt(playerData.talents.demonicKnowledge) || 0;
        talents.demonicTactics = parseInt(playerData.talents.demonicTactics) || 0;
        talents.summonFelguard = parseInt(playerData.talents.summonFelguard) || 0;
        talents.improvedShadowBolt = parseInt(playerData.talents.improvedShadowBolt) || 0;
        talents.cataclysm = parseInt(playerData.talents.cataclysm) || 0;
        talents.bane = parseInt(playerData.talents.bane) || 0;
        talents.improvedFirebolt = parseInt(playerData.talents.improvedFirebolt) || 0;
        talents.improvedLashOfPain = parseInt(playerData.talents.improvedLashOfPain) || 0;
        talents.devastation = parseInt(playerData.talents.devastation) || 0;
        talents.shadowburn = parseInt(playerData.talents.shadowburn) || 0;
        talents.improvedSearingPain = parseInt(playerData.talents.improvedSearingPain) || 0;
        talents.improvedImmolate = parseInt(playerData.talents.improvedImmolate) || 0;
        ...
        talents.shadowAndFlame = parseInt(playerData.talents.shadowAndFlame) || 0;
        ...
        stats.set(module.CharacterStat.health, parseFloat(playerData.stats.health));
        stats.set(module.CharacterStat.mana, parseFloat(playerData.stats.mana));
        stats.set(module.CharacterStat.stamina, parseFloat(playerData.stats.stamina));
        stats.set(module.CharacterStat.intellect, parseFloat(playerData.stats.intellect));
        stats.set(module.CharacterStat.spirit, parseFloat(playerData.stats.spirit));
        ...
        stats.set(module.CharacterStat.fireModifier, parseFloat(playerData.stats.fireModifier));
        stats.set(module.CharacterStat.shadowModifier, parseFloat(playerData.stats.shadowModifier));
        stats.set(module.CharacterStat.staminaModifier, parseFloat(playerData.stats.staminaModifier));
        stats.set(module.CharacterStat.intellectModifier, parseFloat(playerData.stats.intellectModifier));
        stats.set(module.CharacterStat.spiritModifier, parseFloat(playerData.stats.spiritModifier));
        ...
        playerSettings.customIsbUptimeValue = parseFloat(playerData.simSettings.customIsbUptimeValue);
        playerSettings.improvedDivineSpirit = parseInt(playerData.simSettings.improvedDivineSpirit);
        playerSettings.improvedImp = parseInt(playerData.simSettings.improvedImpSetting);
        ...
        playerSettings.hasCorruption = playerData.rotation.dot && playerData.rotation.dot.corruption;
        playerSettings.hasSiphonLife = playerData.rotation.dot && playerData.rotation.dot.siphonLife;
        playerSettings.hasUnstableAffliction = playerData.rotation.dot && playerData.rotation.dot.unstableAffliction;
        playerSettings.hasSearingPain = playerData.rotation.filler && playerData.rotation.filler.searingPain;
        playerSettings.hasShadowBolt = playerData.rotation.filler && playerData.rotation.filler.shadowBolt;
        playerSettings.hasIncinerate = playerData.rotation.filler && playerData.rotation.filler.incinerate;
        playerSettings.hasCurseOfRecklessness = playerData.rotation.curse && playerData.rotation.curse.curseOfRecklessness;
        playerSettings.hasCurseOfTheElements = playerData.rotation.curse && playerData.rotation.curse.curseOfTheElements;
        playerSettings.hasCurseOfAgony = playerData.rotation.curse && playerData.rotation.curse.curseOfAgony;
        playerSettings.hasCurseOfDoom = playerData.rotation.curse && playerData.rotation.curse.curseOfDoom;
        playerSettings.hasDeathCoil = playerData.rotation.finisher && playerData.rotation.finisher.deathCoil;
        playerSettings.hasShadowburn = playerData.rotation.finisher && playerData.rotation.finisher.shadowburn;
        playerSettings.hasConflagrate = playerData.rotation.finisher && playerData.rotation.finisher.conflagrate;
        playerSettings.hasShadowfury = playerData.rotation.other && playerData.rotation.other.shadowfury;
        playerSettings.hasAmplifyCurse = playerData.rotation.other && playerData.rotation.other.amplifyCurse;
        playerSettings.hasDarkPact = playerData.rotation.other && playerData.rotation.other.darkPact;
        playerSettings.hasElementalShamanT4Bonus = playerData.simSettings.improvedWrathOfAirTotem === "yes";
