...
export const Enchants: Enchant[] = [
  // Head
  { name: 'Glyph of Power', varName: 'glyphOfPower', itemSlot: ItemSlotKey.Head, spellPower: 22, hitRating: 14, id: 35447, source: ItemSource.ShatarRevered, phase: 1, quality: Quality.Uncommon },
  { name: 'Glyph of Renewal', varName: 'glyphOfRenewal', itemSlot: ItemSlotKey.Head, spellPower: 12, mp5: 7, id: 35445, source: ItemSource.HonorHoldOrThrallmarRevered, phase: 1, quality: Quality.Uncommon },
  { name: 'Glyph of Fire Warding', varName: 'glyphOfFireWarding', itemSlot: ItemSlotKey.Head, fireResist: 20, id: 35456, source: ItemSource.HonorHoldOrThrallmarHonored, phase: 1, quality: Quality.Uncommon },
  { name: 'Glyph of Shadow Warding', varName: 'glyphOfShadowWarding', itemSlot: ItemSlotKey.Head, shadowResist: 20, id: 35458, source: ItemSource.LowerCityHonored, phase: 1, quality: Quality.Uncommon },
  { name: 'Glyph of Arcane Warding', varName: 'glyphOfArcaneWarding', itemSlot: ItemSlotKey.Head, arcaneResist: 20, id: 35455, source: ItemSource.ShatarHonored, phase: 1, quality: Quality.Uncommon },
  { name: 'Glyph of Nature Warding', varName: 'glyphOfNatureWarding', itemSlot: ItemSlotKey.Head, natureResist: 20, id: 35454, source: ItemSource.CenarionExpeditionHonored, phase: 1, quality: Quality.Uncommon },
  { name: 'Glyph of Frost Warding', varName: 'glyphOfFrostWarding', itemSlot: ItemSlotKey.Head, frostResist: 20, id: 35457, source: ItemSource.KeepersOfTimeHonored, phase: 1, quality: Quality.Uncommon },
  { name: 'Glyph of Chromatic Warding', varName: 'glyphOfChromaticWarding', itemSlot: ItemSlotKey.Head, arcaneResist: 8, fireResist: 8, natureResist: 8, shadowResist: 8, frostResist: 8, id: 37889, source: ItemSource.LowerCityHonored, phase: 1, quality: Quality.Uncommon },
  { name: 'Hoodoo Hex', varName: 'hoodooHex', itemSlot: ItemSlotKey.Head, stamina: 10, spellPower: 18, id: 24165, source: ItemSource.ZulGurub, phase: 0, quality: Quality.Rare },

  // Shoulders
  { name: 'Greater Inscription of Discipline', varName: 'greaterInscriptionOfDiscipline', itemSlot: ItemSlotKey.Shoulders, spellPower: 18, critRating: 10, id: 35406, source: ItemSource.AldorExalted, phase: 1, quality: Quality.Rare },
  { name: 'Greater Inscription of the Orb', varName: 'greaterInscriptionOfTheOrb', itemSlot: ItemSlotKey.Shoulders, spellPower: 12, critRating: 15, id: 35437, source: ItemSource.ScryersExalted, phase: 1, quality: Quality.Rare },
  { name: 'Inscription of Discipline', varName: 'inscriptionOfDiscipline', itemSlot: ItemSlotKey.Shoulders, spellPower: 15, id: 35405, source: ItemSource.AldorHonored, phase: 1, quality: Quality.Uncommon },
  { name: 'Inscription of the Orb', varName: 'inscriptionOfTheOrb', itemSlot: ItemSlotKey.Shoulders, critRating: 13, id: 35436, source: ItemSource.ScryersHonored, phase: 1, quality: Quality.Uncommon },
  { name: 'Inscription of Endurance', varName: 'inscriptionOfEndurance', itemSlot: ItemSlotKey.Shoulders, fireResist: 7, shadowResist: 7, arcaneResist: 7, natureResist: 7, frostResist: 7, id: 35441, source: ItemSource.VioletEyeHonored, phase: 1, quality: Quality.Uncommon },
  { name: 'Power of the Scourge', varName: 'powerOfTheScourge', itemSlot: ItemSlotKey.Shoulders, spellPower: 15, critRating: 14, id: 29467, source: ItemSource.Naxxramas, phase: 0, quality: Quality.Epic },
  { name: 'Zandalar Signet of Mojo', varName: 'zandalarSignetOfMojo', itemSlot: ItemSlotKey.Shoulders, spellPower: 18, id: 24421, source: ItemSource.ZandalarTribeExalted, phase: 0, quality: Quality.Rare },

  // Back
  { name: 'Subtlety', varName: 'subtlety', itemSlot: ItemSlotKey.Back, threatReduction: 0.02, id: 25084, source: ItemSource.Enchanting, phase: 0, quality: Quality.Rare },
  ...
  { id: 27958, name: 'Exceptional Mana', varName: 'exceptionalMana', itemSlot: ItemSlotKey.Chest, mana: 150, source: ItemSource.Enchanting, phase: 1, quality: Quality.Uncommon },
  ...
  { name: 'Nature Armor Kit', varName: 'natureArmorKit', itemSlot: ItemSlotKey.Chest, natureResist: 8, id: 35419, source: ItemSource.Leatherworking, phase: 1, quality: Quality.Uncommon },
  { name: 'Frost Armor Kit', varName: 'frostArmorKit', itemSlot: ItemSlotKey.Chest, frostResist: 8, id: 35418, source: ItemSource.Leatherworking, phase: 1, quality: Quality.Uncommon },
  { name: 'Greater Stats', varName: 'greaterStats', itemSlot: ItemSlotKey.Chest, stamina: 4, intellect: 4, spirit: 4, id: 20025, source: ItemSource.Enchanting, phase: 0, quality: Quality.Uncommon },
  ...
  { name: 'Nature Armor Kit', varName: 'natureArmorKit', itemSlot: ItemSlotKey.Gloves, natureResist: 8, id: 35419, source: ItemSource.Leatherworking, phase: 1, quality: Quality.Uncommon },
  { name: 'Frost Armor Kit', varName: 'frostArmorKit', itemSlot: ItemSlotKey.Gloves, frostResist: 8, id: 35418, source: ItemSource.Leatherworking, phase: 1, quality: Quality.Uncommon },
  ...
  { name: 'Nature Armor Kit', varName: 'natureArmorKit', itemSlot: ItemSlotKey.Legs, natureResist: 8, id: 35419, source: ItemSource.Leatherworking, phase: 1, quality: Quality.Uncommon },
  { name: 'Frost Armor Kit', varName: 'frostArmorKit', itemSlot: ItemSlotKey.Legs, frostResist: 8, id: 35418, source: ItemSource.Leatherworking, phase: 1, quality: Quality.Uncommon },
  { name: 'Hoodoo Hex', varName: 'hoodooHex', itemSlot: ItemSlotKey.Legs, stamina: 10, spellPower: 18, id: 24165, source: ItemSource.ZulGurub, phase: 0, quality: Quality.Rare },
  ...
  { name: 'Nature Armor Kit', varName: 'natureArmorKit', itemSlot: ItemSlotKey.Boots, natureResist: 8, id: 35419, source: ItemSource.Leatherworking, phase: 1, quality: Quality.Uncommon },
  ...
  { name: 'Major Spellpower', varName: 'majorSpellpower', itemSlot: ItemSlotKey.Mainhand, spellPower: 40, id: 27975, source: ItemSource.Enchanting, phase: 1, quality: Quality.Uncommon },
  { name: 'Sunfire', varName: 'sunfire', itemSlot: ItemSlotKey.Mainhand, firePower: 50, id: 27981, source: ItemSource.Enchanting, phase: 1, quality: Quality.Rare },
  { name: 'Major Intellect', varName: 'majorIntellect', itemSlot: ItemSlotKey.Mainhand, intellect: 30, id: 27968, source: ItemSource.Enchanting, phase: 1, quality: Quality.Uncommon },
  { name: 'Spell Power', varName: 'spellPower', itemSlot: ItemSlotKey.Mainhand, spellPower: 30, id: 22749, source: ItemSource.Enchanting, phase: 0, quality: Quality.Rare }
]