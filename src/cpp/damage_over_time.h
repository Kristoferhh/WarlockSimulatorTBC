...
struct DamageOverTime {
  ...
  int originalDuration;  // Used for T4 4pc since we're increasing the duration
                         // by 3 seconds but need to know what the original
                         // duration was
  int tickTimerTotal;    // Total duration of each tick (default is 3 seconds
                         // between ticks)
  ...
  int minimumDuration;  // Minimum time left of the fight for the sim to
