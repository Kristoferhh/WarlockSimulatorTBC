...
EMSCRIPTEN_KEEPALIVE
Items* allocItems(int head, int neck, int shoulders, int back, int chest, int bracers, int gloves, int belt, int legs, int boots, int finger1, int finger2, int trinket1, int trinket2, int mainHand, int offHand, int twoHand, int wand)
{
...
EMSCRIPTEN_KEEPALIVE
SimulationSettings* allocSimSettings(int iterations, int minTime, int maxTime, unsigned int* randomSeeds, SimulationType simulationType)
{
    return new SimulationSettings(iterations, minTime, maxTime, randomSeeds, simulationType);
}
