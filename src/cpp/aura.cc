...
FlameshadowAura::FlameshadowAura(Player& player) : Aura(player) {
  ...
  duration = 15;
  proc_chance = 5;
  Aura::stats = std::vector<Stat>{ShadowPower(135)};
  Setup();
}
...
ShadowflameAura::ShadowflameAura(Player& player) : Aura(player) {
  ...
  duration = 15;
  proc_chance = 5;
  Aura::stats = std::vector<Stat>{FirePower(135)};
  Setup();
}
...
SpellstrikeAura::SpellstrikeAura(Player& player) : Aura(player) {
  ...
  duration = 10;
  proc_chance = 5;
  Aura::stats = std::vector<Stat>{SpellPower(92)};
  Setup();
}
...
PowerInfusionAura::PowerInfusionAura(Player& player) : Aura(player) {
  name = "Power Infusion";
  duration = 15;
  Aura::stats = std::vector<Stat>{HastePercent(1.2), ManaCostModifier(0.8)};
  Setup();
}
...
EyeOfMagtheridonAura::EyeOfMagtheridonAura(Player& player) : Aura(player) {
  ...
  duration = 10;
  Aura::stats = std::vector<Stat>{SpellPower(170)};
  Setup();
}
...
SextantOfUnstableCurrentsAura::SextantOfUnstableCurrentsAura(Player& player) : Aura(player) {
  ...
  duration = 15;
  Aura::stats = std::vector<Stat>{SpellPower(190)};
  Setup();
}
...
QuagmirransEyeAura::QuagmirransEyeAura(Player& player) : Aura(player) {
  ...
  duration = 6;
  Aura::stats = std::vector<Stat>{HasteRating(320)};
  Setup();
}
...
ShiffarsNexusHornAura::ShiffarsNexusHornAura(Player& player) : Aura(player) {
  ...
  duration = 10;
  Aura::stats = std::vector<Stat>{SpellPower(225)};
  Setup();
}
...
ManaEtched4SetAura::ManaEtched4SetAura(Player& player) : Aura(player) {
  ...
  duration = 15;
  proc_chance = 2;
  Aura::stats = std::vector<Stat>{SpellPower(110)};
  Setup();
}
...
DestructionPotionAura::DestructionPotionAura(Player& player) : Aura(player) {
  ...
  duration = 15;
  Aura::stats = std::vector<Stat>{SpellPower(120), CritChance(2)};
  Setup();
}
...
FlameCapAura::FlameCapAura(Player& player) : Aura(player) {
  name = "Flame Cap";
  duration = 60;
  Aura::stats = std::vector<Stat>{FirePower(80)};
  Setup();
}
...
BloodFuryAura::BloodFuryAura(Player& player) : Aura(player) {
  name = "Blood Fury";
  duration = 15;
  Aura::stats = std::vector<Stat>{SpellPower(140)};
  Setup();
}
...
BloodlustAura::BloodlustAura(Player& player) : Aura(player) {
  ...
  duration = 40;
  group_wide = true;
  Aura::stats = std::vector<Stat>{HastePercent(1.3)};
  Setup();
}
...
DrumsOfBattleAura::DrumsOfBattleAura(Player& player) : Aura(player) {
  ...
  duration = 30;
  group_wide = true;
  Aura::stats = std::vector<Stat>{HasteRating(80)};
  Setup();
}
...
DrumsOfWarAura::DrumsOfWarAura(Player& player) : Aura(player) {
  ...
  duration = 30;
  group_wide = true;
  Aura::stats = std::vector<Stat>{SpellPower(30)};
  Setup();
}
...
AshtongueTalismanOfShadowsAura::AshtongueTalismanOfShadowsAura(Player& player) : Aura(player) {
  ...
  duration = 5;
  proc_chance = 20;
  Aura::stats = std::vector<Stat>{SpellPower(220)};
  Setup();
}
...
BandOfTheEternalSageAura::BandOfTheEternalSageAura(Player& player) : Aura(player) {
  ...
  duration = 10;
  Aura::stats = std::vector<Stat>{SpellPower(95)};
  Setup();
}
...
BladeOfWizardryAura::BladeOfWizardryAura(Player& player) : Aura(player) {
  ...
  duration = 6;
  proc_chance = 15;
  Aura::stats = std::vector<Stat>{HasteRating(280)};
  Setup();
}
...
ShatteredSunPendantOfAcumenAura::ShatteredSunPendantOfAcumenAura(Player& player) : Aura(player) {
  ...
  duration = 10;
  Aura::stats = std::vector<Stat>{SpellPower(120)};
  Setup();
}
...
RobeOfTheElderScribesAura::RobeOfTheElderScribesAura(Player& player) : Aura(player) {
  ...
  duration = 10;
  Aura::stats = std::vector<Stat>{SpellPower(130)};
  Setup();
}
...
WrathOfCenariusAura::WrathOfCenariusAura(Player& player) : Aura(player) {
  ...
  duration = 10;
  proc_chance = 5;
  Aura::stats = std::vector<Stat>{SpellPower(132)};
  Setup();
}
...
ChippedPowerCoreAura::ChippedPowerCoreAura(Player& player) : Aura(player) {
  ...
  duration = 30;
  Aura::stats = std::vector<Stat>{SpellPower(25)};
  Setup();
}
...
CrackedPowerCoreAura::CrackedPowerCoreAura(Player& player) : Aura(player) {
  ...
  duration = 30;
  Aura::stats = std::vector<Stat>{SpellPower(15)};
  Setup();
}