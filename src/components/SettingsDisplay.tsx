    ...
    <section id="sim-settings">
      ...
      <ul>
        ...
        <li id='automatically-open-sim-details'>
          ...
          <select className="settings-right" name="automatically-open-sim-details" onChange={(e) => settingModifiedHandler(Setting['automatically-open-sim-details'], e.target.value)} value={playerStore.settings['automatically-open-sim-details']}>
        ...
        <li id='randomizeValues' title="Chooses a random value between a minimum and a maximum value instead of taking the average of the two.">
          ...
          <select className="settings-right" name="randomizeValues" onChange={(e) => settingModifiedHandler(Setting.randomizeValues, e.target.value)} value={playerStore.settings.randomizeValues}>
            <option value="no">No</option>
            <option value="yes">Yes</option>
          </select>
        </li>
        <li id="infinitePlayerMana">
          ...
          <select className="settings-right" name="infinitePlayerMana" onChange={(e) => settingModifiedHandler(Setting.infinitePlayerMana, e.target.value)} value={playerStore.settings.infinitePlayerMana}>
            <option value="no">No</option>
            <option value="yes">Yes</option>
          </select>
        </li>
        <li id="infinitePetMana">
          ...
          <select className="settings-right" name="infinitePetMana" onChange={(e) => settingModifiedHandler(Setting.infinitePetMana, e.target.value)} value={playerStore.settings.infinitePetMana}>
            <option value="no">No</option>
            <option value="yes">Yes</option>
          </select>
        </li>
        ...
        }
        {
          isPetActive(playerStore.talents, playerStore.settings, false) &&
            <li id="petMode">
              ...
              <select className="settings-right" name="petMode" onChange={(e) => settingModifiedHandler(Setting.petMode, e.target.value)} value={playerStore.settings.petMode}>
        ...
        {
          isPetActive(playerStore.talents, playerStore.settings, true) &&
            <li id="prepopBlackBook">
              <label className="settings-left" htmlFor="prepopBlackBook">Prepop Black Book?</label>
              <select className="settings-right" name="prepopBlackBook" onChange={(e) => settingModifiedHandler(Setting.prepopBlackBook, e.target.value)} value={playerStore.settings.prepopBlackBook}>
                <option value="no">No</option>
                <option value="yes">Yes</option>
              </select>
            </li>
          ...
          playerStore.selectedItems.neck === 34678 &&
            <>
              ...
              <li id="shattrathFactionReputation">
                ...
                <select className="settings-right" name="shattrathFactionReputation" onChange={(e) => settingModifiedHandler(Setting.shattrathFactionReputation, e.target.value)} value={playerStore.settings.shattrathFactionReputation}>
                  <option value="no">No</option>
                  <option value="yes">Yes</option>
                </select>
              </li>
        ...
        }
        {
          ...
          isPetActive(playerStore.talents, playerStore.settings, true) && playerStore.settings.petChoice === '2' &&
            <li id="lashOfPainUsage">
              <label className='settings-left' htmlFor='lashOfPainUsage'>When to use Lash of Pain?</label>
              <select className='settings-right' name='lashOfPainUsage' onChange={(e) => settingModifiedHandler(Setting.lashOfPainUsage, e.target.value)} value={playerStore.settings.lashOfPainUsage}>
        ...
        }
        {
          isPetActive(playerStore.talents, playerStore.settings, true) &&
            <li id="enemyArmor">
              ...
              <input className="settings-right" onChange={(e) => settingModifiedHandler(Setting.enemyArmor, e.target.value)} value={playerStore.settings.enemyArmor} type="number" min='0' max='10000' name="enemyArmor" />
            </li>
        }
        {
        ...
        {
          playerStore.auras.faerieFire && isPetActive(playerStore.talents, playerStore.settings, true) &&
        ...
        {
          playerStore.auras.exposeArmor && isPetActive(playerStore.talents, playerStore.settings, true) &&
        ...
        {
          playerStore.auras.exposeWeakness && isPetActive(playerStore.talents, playerStore.settings, true) &&
            <div>
              <li id='survivalHunterAgility'>
                <label className="settings-left" htmlFor="survivalHunterAgility">Survival Hunter Agility</label>
                <input className='settings-right' onChange={(e) => settingModifiedHandler(Setting.survivalHunterAgility, e.target.value)} value={playerStore.settings.survivalHunterAgility} type="number" min='0' name="survivalHunterAgility" />
              </li>
              <li id='exposeWeaknessUptime'>
                <label className="settings-left" htmlFor="exposeWeaknessUptime">Expose Weakness Uptime %</label>
                <input className='settings-right' onChange={(e) => settingModifiedHandler(Setting.exposeWeaknessUptime, e.target.value)} value={playerStore.settings.exposeWeaknessUptime} type="number" min='0' name="exposeWeaknessUptime" />
              </li>
            </div>
        }
        <li id="customIsbUptime">
          <label className="settings-left" htmlFor="customIsbUptime">Use custom ISB uptime %?</label>
          <select className="settings-right" name="customIsbUptime" onChange={(e) => settingModifiedHandler(Setting.customIsbUptime, e.target.value)} value={playerStore.settings.customIsbUptime}>
            <option value="yes">Yes</option>
            <option value="no">No</option>
          </select>
        </li>
