...
export default function GemSelection() {
  ...
  function gemClickHandler(gem: Gem) {
    ...
    if (currentItemSocketArray == null) {
      ...
      if (
        currentItemSocketArray[uiState.gemSelectionTable.socketNumber] &&
        currentItemSocketArray[uiState.gemSelectionTable.socketNumber][1] ===
          gem.id
      ) {
        return;
      }
      ...
      <tbody>
        <tr>
          ...
          <td
            ...
            onClick={(_e) => setShowingHiddenGems(!showingHiddenGems)}
            style={{
          ...
          .map((gem) => (
            ...
            >
              ...
              <td
                ...
                onClick={(_e) => dispatch(hideGem(gem.id))}
              >
                ❌
              </td>
            </tr>
