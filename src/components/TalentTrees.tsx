          ...
          Talents.map(talentTree =>
            <div key={talentTree.name} className="talent-tree-div">
                            ...
                            <td key={nanoid()}>
                              {
                                ...
                                <div
                                  ...
                                  <a
                                    href={`${getBaseWowheadUrl(i18n.language)}/spell=${talent.rankIDs[Math.max(talentState[talent.varName!] - 1, 0) || 0]}`}
                                  ...
                                  >
                                    ...
                                    <span
                                      ...
                                      className={'talent-point-amount' +
                                        (talentState[talent.varName!] && talentState[talent.varName!] === talent.rankIDs.length ?
                                          ' maxed-talent' : '') +
                                        (talentState[talent.varName!] && talentState[talent.varName!] > 0 && talentState[talent.varName!] < talent.rankIDs.length ?
                                          ' half-full-talent' : '') +
                                        (talentState[talent.varName!] == null || talentState[talent.varName!] === 0 ?
                                          ' empty-talent' : '')}>
              ...
              <div className='talent-tree-name'>
                ...
                >{t(talentTree.name) + ' ' + (getAllocatedTalentsPointsInTree(talentState, talentTree) > 0 ?
