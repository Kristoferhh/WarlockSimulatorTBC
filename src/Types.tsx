...
export interface Settings {
  ...
  improvedCurseOfTheElements: number,
  iterations: number,
  'min-fight-length': number,
  'max-fight-length': number,
  'target-level': number,
  petChoice: number,
  totemOfWrathAmount: number,
  petMode: number,
  sacrificePet: string,
  enemyArmor: number,
  mageAtieshAmount: number,
  warlockAtieshAmount: number,
  'target-shadow-resistance': number,
  'target-fire-resistance': number,
  improvedExposeArmor: number,
  improvedFaerieFire: string,
  bloodlustAmount: number,
  shadowPriestDps: number,
  survivalHunterAgility: number,
  ...
  fightType: string,
  enemyAmount: number,
  powerInfusionAmount: number,
  innervateAmount: number,
  ferociousInspirationAmount: number,
  improvedImpSetting: number,
  improvedWrathOfAirTotem: string,
}

export const InitialSettings: {[key: string]: any} = {
  race: Race.Gnome,
