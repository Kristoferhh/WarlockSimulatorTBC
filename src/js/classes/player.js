class Player {
  ...
  initialize () {
    ...
    if (this.talents.amplifyCurse == 1 && (this.rotation.curse.curseOfDoom || this.rotation.curse.curseOfAgony)) this.spells.amplifyCurse = new AmplifyCurse(this)
    ...
    if (this.talents.amplifyCurse == 1 && (this.rotation.curse.curseOfDoom || this.rotation.curse.curseOfAgony)) this.auras.amplifyCurse = new AmplifyCurseAura(this)
